...
require_once ICEBERG_DIR_HELPERS . 'time.php';
 ...
 * @version 1.0
 */
class Time extends ObjectConfig
{
    /**
     * Configuration key
     * @var string
     */
    public static $CONFIG_KEY = 'time_config';
     ...
     * @var array 
     */
    static private $TimeZonesList = array(
    ...
    {
        $timezone = static::GetConfigValue('timezone', 'Europe/Madrid');
    ...
    {
        return static::GetConfigValue('date_format', static::$CONFIG_DEFAULTS['time_format']);
    }
    
    public static function GetTimeFormat()
    {
        return static::GetConfigValue('time_format', static::$CONFIG_DEFAULTS['time_format']);
    }
    
    public static function GetDateTimeFormat()
    {
        return static::GetConfigValue('datetime_format', static::$CONFIG_DEFAULTS['time_format']);
    }
