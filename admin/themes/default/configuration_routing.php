...
?>
<form action="<?php print get_admin_action_link(array('action'=>'save')); ?>" method="post" id="configuration-routing" validate>
    <div class="well">
        <header><?php print_text('Routing'); ?></header>
        
        <div class="row-fluid">
            
            <div class="span6">
                <div class="well">
                    <header><?php print_text('Conincal'); ?></header>
                    <?php foreach ($r_canonicals AS $r_canonical_loop_id => $r_canonical_loop): ?>
                    <p class="radio">
                        <label for="routing_canonical_<?php echo $r_canonical_loop_id; ?>">
            ...
            <div class="span6">
                <div class="well">
                    <header><?php print_text('Routing type'); ?></header>
                    <?php foreach ($r_types AS $r_types_loop_id => $r_types_loop): ?>
                    <p class="radio">
                        <label for="routing_type_<?php echo $r_types_loop_id; ?>">
        ...
        <div class="row-fluid">
            <div class="span4">
                <h5><?php print_text('Domains'); ?></h5>
                <ul class="unstyled language-list" id="domains-list" data-sortable="droppable" data-sortable-connect=".language-list">
            ...
            <div class="span8">
                ...
                <h5><img src="<?php print get_flag_url($lang['flag']); ?>" alt="<?php print $locale; ?>" /> <?php echo $lang['name']; ?></h5>
                <ul class="unstyled language-list" id="language-<?php print $locale; ?>" data-sortable="droppable" data-sortable-connect=".language-list" data-sortable-update="#language-domains-<?php print $locale; ?>">
